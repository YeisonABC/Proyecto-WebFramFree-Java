...
public class detalleFacturaDAO extends conexion {
    ...
    public ArrayList<detalleFacturaDTO> listaDetalle() {
        ...
        try {
            String sql = "SELECT * FROM detalle_factura"; //SELECT * FROM productos p, tipo_producto tp, produccion pr WHERE tp.Id_TipoProducto = p.Id_TipoProducto AND tp.Id_TipoProducto = pr.Id_TipoProducto
