...
<html>
    ...
    <body>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>                  
                            ...
                            <td><%                    out.println(Persona.getNombrePersona());
                            ...
                            <td><%                    out.println(Persona.getFechaVinculacion());
                            ...
                            <td>
                                <a href="updatePersonaEmpleado.jsp?codigo=<%=Persona.getCodigoPersona()%>&&nombreCargo=<%=Persona.getNombreCargo()%>&&codigoCargo=<%=Persona.getCodigoCargo()%>&&nombre=<%=Persona.getNombrePersona()%>&&apellido=<%=Persona.getApellido()%>&&genero=<%=Persona.getGenero()%>&&cedula=<%=Persona.getCedula()%>&&fecha=<%=Persona.getFechaVinculacion()%>&&telefono=<%=Persona.getTelefono()%>&&tPersona=<%=Persona.getTipoPersona()%>"><i class="fas fa-pencil-alt"></i>
                                </a>
                            </td>
                            <td>
                                <a href="deletePersona.jsp?codigo=<%=Persona.getCodigoPersona()%>"><i class="far fa-trash-alt" style="color:#DF2A2A;"></i></a>
                                    <%
                                        }
                                    %>
                            </td>
        ...
        <table>
            ...
            <tbody>
                <c:forEach var="miLista" items="${listaPersona}">
                    <tr>
                        <td>${miLista.nombres}</td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
