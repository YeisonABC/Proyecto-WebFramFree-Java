                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <%
                                    out.print(cargos.getCodioCargo());
                                %>
                            </td>
                            <td>
                                <%
                            ...
                            <td>
                                <a href="editarCargo.jsp?codigo=<%=cargos.getCodioCargo()%>&&nombre=<%=cargos.getNombre()%>"><button class="btn btn-link">Editar</button></a>
                            </td>
                            <td>
                                <a href="borrarCargo.jsp?codigo=<%=cargos.getCodioCargo()%>"><button class="btn btn-danger">Borrar</button></a>
                            </td>
                            <%
                                }
                            %>
