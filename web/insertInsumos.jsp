<%-- 
    Document   : insertInsumos
    Created on : 12/01/2020, 05:23:55 PM
...
<html>
    ...
    <body>
        <div class="mt-4"><p class="h4 text-center">Nuevo Insumo</p></div>
        <div class=" formularioCliente">
            <form action="controladorInsertInsumos">
                <input type="text" name="nombre"  class="form-control form-control-lg " placeholder="Nombre"><br>
                <input type="number" name="cantidad"  class="form-control form-control-lg " placeholder="Cantidad"><br>
                <input type="number" name="precio"  class="form-control form-control-lg " placeholder="Precio"><br>
                <input type="date" name="fecha"  class="form-control form-control-lg " placeholder="Fecha"><br>
                <input type="text" name="descripcion"  class="form-control form-control-lg " placeholder="Descripcion"><br>
                <input type="submit" value="REGISTRAR"  class="form-control form-control-lg " placeholder="Nombres"><br>
