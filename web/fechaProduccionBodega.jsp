<%-- 
    Document   : fechaProduccion
    Created on : 9/05/2020, 09:46:49 PM
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <%
                            ...
                            String fecha = (String) request.getAttribute("lista");
                            ArrayList<productosDTO> miLista = lproduc.listaPorFecha(fecha);
