<%-- 
    Document   : insertProduccion
    Created on : 15/01/2020, 03:21:10 PM
...
<html>
    ...
    <body>
        ...
        <div class="mt-5"><p class="h4 text-center">Ingresa el Registro</p></div>
        <div class="formularioCliente">
            <form action="controladorEditaProduccion" method="get">
                <select name="nombre" class="form-control form-control-lg ">
               ...
               <input type="date" name="fecha" class="form-control form-control-lg " placeholder="Fecha"><br>
                ...
                <input type="submit" value="Enviar" class="form-control form-control-lg">            
            </form>
